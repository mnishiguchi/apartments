Rails.application.routes.draw do
  # transit/dc/washington/mcpherson-square/over-500_pet-friendly-dog/dishwasher_parking/
  get "transit/:state/:location/:name/*filter",
      to: "apartments#transit",
      constraints: { state: /\w{2}/ }, as: :transit_apartments
  # military/va/arlington/the-pentagon/over-500_pet-friendly-dog/dishwasher_parking/
  get "military/:state/:location/:name/*filter",
      to: "apartments#military",
      constraints: { state: /\w{2}/ }, as: :military_apartments
  # off-campus-housing/dc/washington/university-of-the-district-of-columbia/over-500_pet-friendly/
